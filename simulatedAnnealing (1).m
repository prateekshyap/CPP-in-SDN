function [ fs, optCost, x, y, xx, counter ] = simulatedAnnealing( mat, n, tMax, tMin, noi, cf, noc )
...
[l, cost] = capacitedCost (fs, mat, n); %finding out the total cost of the network for fs
...
while (t > tMin) %current temperature should be more than minimum temperature
    ...
    for i = 1 : noi %for each iteration
        ...
        [l2, cost2] = capacitedCost (fs2, mat, n); %cost for new combination fs2

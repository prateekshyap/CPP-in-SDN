function [ fs, optCost, x, y, xx, counter, l, retRand ] = simulatedAnnealingL( mat, n, tMax, tMin, noi, cf, noc )
...
[l, cost] = capacitedCostL (fs, mat, n); %finding out the total cost of the network for fs
...
while (t > tMin) %current temperature should be more than minimum temperature
    ...
    for i = 1 : noi %for each iteration
        ...
        [l2, cost2] = capacitedCostL (fs2, mat, n); %cost for new combination fs2

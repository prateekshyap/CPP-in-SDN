% function [ fs, optCost, optCostF, optLat, optLoad, x, y1, y2, xx, counter, retRand, optConn ] = simulatedAnnealingFailure( mat, n, tMax, tMin, noi, cf, noc )
function [ fs, optCost, optCostF, optCostF2, optLat, optLoad, x, y1, y2, y3, xx, counter, retRand, optConn ] = simulatedAnnealingFailure( mat, n, tMax, tMin, noi, cf, noc )
...
[lF, costF, latF, connF] = costWithFailure(fs, mat, n, 1); %finding out the total cost for 1 failure
[lF3, costF3, latF3, connF3] = costWithFailure(fs, mat, n, 2); %finding out the total cost for second failure
...
while (t > tMin) %current temperature should be more than minimum temperature
    ...
    for i = 1 : noi %for each iteration
        ...
        [lF2, costF2, latF2, connF2] = costWithFailure (fs2, mat, n, 1); %cost for one failure
        [lF22, costF22, latF22, connF22] = costWithFailure (fs2, mat, n, 2); %cost for second failure

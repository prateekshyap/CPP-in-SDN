...
for cont = 1 : maxNoc %for each number of controllers
    tic; %timer starts
%     [controllers, cost, costF, lat, loads, xTemps, yCosts, yFCosts, xxIts, counter, randCont, optConnSa] = simulatedAnnealingFailure(mat, n, 10, 0.001, maxIterations, 0.95, cont, shortestPathMatrix);
    [controllers, cost, costF, costF2, lat, loads, xTemps, yCosts, yFCosts, yF2Costs, xxIts, counter, randCont, optConnSa] = simulatedAnnealingFailure(mat, n, 10, 0.001, maxIterations, 0.95, cont, shortestPathMatrix);
    cont
    cost
    costF
    costF2
